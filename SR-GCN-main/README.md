...
```
# Example: training SRGCN on NTU RGB+D 120 cross subject with GPU 0
...
```
# Example: training SRGCN on NTU RGB+D 120 cross subject under bone modality
...
```
# Example: ensemble four modalities of SRGCN on NTU RGB+D 120 cross subject
